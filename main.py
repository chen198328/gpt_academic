...
def main():
    ...
    title_html = f"<h1 align=\"center\">ChatGPT 学术优化版 v{get_current_version()}</h1>{theme_declaration}"
    ...
    cancel_handles = []
    with gr.Blocks(title="ChatGPT 学术优化版", theme=set_theme, analytics_enabled=False, css=advanced_css) as demo:
        gr.HTML(title_html)
